...
SRA_Datasets = list(['SRR20106162', 'SRR20106163', 'SRR20106164', 'SRR20106165'])
...
ResultsDF.to_csv('Part10_RP_alignment_gene_3UTR_HAS_dORF_results.csv') ###modify name
...
for i in range(len(SRA_Datasets)):
    ...
    tempResultsDF.to_csv('Part10_RP_alignment_gene_3UTR_HAS_dORF_results.csv', header=None, mode='a')
