...
SRA_Datasets = list(['SRR20106154', 'SRR20106155', 'SRR20106156', 'SRR20106157'])
...
ResultsDF.to_csv('Part8_RP_alignment_gene_3UTR_HAS_dORF_results.csv') ###modify name
...
for i in range(len(SRA_Datasets)):
    ...
    tempResultsDF.to_csv('Part8_RP_alignment_gene_3UTR_HAS_dORF_results.csv', header=None, mode='a')
