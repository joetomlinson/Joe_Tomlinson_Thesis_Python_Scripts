...
ResultsDF_Ctrl.to_csv('Human_and_Btaurus_ResultsDF_Ctrl_200_upstream_water_included.csv')
...
for i in range(len(ResultsDF)):
    ...
    if HumanCtrlstart > -1 and HomologCtrlstart > -1:
        ...
        if CtrlTemp_Length >= HumanCtrlLen or CtrlTemp_Length >= HomologCtrlLen:
            ...
            tempResultsDF.to_csv('Human_and_Btaurus_ResultsDF_Ctrl_200_upstream_water_included.csv', header=None, mode='a')
        else:
            continue
    else:
        continue
