...
ResultsDF_Ctrl.to_csv('Human_and_Celegans_ResultsDF_Ctrl_100_downstream_water_included.csv')
...
for i in range(len(ResultsDF)):
    ...
    if HumanCtrlend < tempResultsDF['Human 3UTR Length'][0] and HomologCtrlend < tempResultsDF['Homolog 3UTR Length'][0]:
        ...
        if CtrlTemp_Length >= HumanCtrlLen or CtrlTemp_Length >= HomologCtrlLen:
            ...
            tempResultsDF.to_csv('Human_and_Celegans_ResultsDF_Ctrl_100_downstream_water_included.csv', header=None, mode='a')
        else:
            continue
    else:
        continue
