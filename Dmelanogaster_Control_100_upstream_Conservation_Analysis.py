#Python Script to analyse similarity of control sequences in human and homolog species of the dORF lengths finishing 100 bases upstream of the dORF start codon and add results to conservation analysis results
...
ResultsDF_Ctrl.to_csv('Human_and_Dmelanogaster_ResultsDF_Ctrl_100_upstream_water_included.csv')
...
for i in range(len(ResultsDF)):
    ...
    HumanCtrlend = HumandORFstart - 100
    ...
    HomologCtrlend = HomologdORFstart - 100
    ...
    if HumanCtrlstart > -1 and HomologCtrlstart > -1:
        ...
        if CtrlTemp_Length >= HumanCtrlLen or CtrlTemp_Length >= HomologCtrlLen:
            ...
            tempResultsDF.to_csv('Human_and_Dmelanogaster_ResultsDF_Ctrl_100_upstream_water_included.csv', header=None, mode='a')
        else:
            continue
    else:
        continue
