...
SRA_Datasets = list(['SRR20106166', 'SRR20106167', 'SRR20106168'])
...
ResultsDF.to_csv('Part11_RP_alignment_gene_3UTR_HAS_dORF_results.csv') ###modify name
...
for i in range(len(SRA_Datasets)):
    ...
    tempResultsDF.to_csv('Part11_RP_alignment_gene_3UTR_HAS_dORF_results.csv', header=None, mode='a')
