...
ResultsDF.to_csv('Part7_RP_alignment_gene_3UTR_26MS_dORF_results.csv')
...
for i in range(len(SRA_Datasets)):
    ...
    tempResultsDF.to_csv('Part7_RP_alignment_gene_3UTR_26MS_dORF_results.csv', header=None, mode='a')
