...
SRA_Datasets = list(['SRR20106158', 'SRR20106159', 'SRR20106160', 'SRR20106161'])
...
ResultsDF.to_csv('Part9_RP_alignment_gene_3UTR_HAS_dORF_results.csv') ###modify name
...
for i in range(len(SRA_Datasets)):
    ...
    tempResultsDF.to_csv('Part9_RP_alignment_gene_3UTR_HAS_dORF_results.csv', header=None, mode='a')
