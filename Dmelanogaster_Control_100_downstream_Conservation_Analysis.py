#Python Script to analyse similarity of control sequences in human and homolog species of the dORF lengths 100 bases downstream of the dORF stop codon and add results to conservation analysis results
...
ResultsDF_Ctrl.to_csv('Human_and_Dmelanogaster_ResultsDF_Ctrl_100_downstream_water_included.csv')
...
for i in range(len(ResultsDF)):
    ...
    HumanCtrlstart = HumandORFend + 99
    ...
    HomologCtrlstart = HomologdORFend + 99
    ...
    if HumanCtrlend < tempResultsDF['Human 3UTR Length'][0] and HomologCtrlend < tempResultsDF['Homolog 3UTR Length'][0]:
        ...
        if CtrlTemp_Length >= HumanCtrlLen or CtrlTemp_Length >= HomologCtrlLen:
            ...
            tempResultsDF.to_csv('Human_and_Dmelanogaster_ResultsDF_Ctrl_100_downstream_water_included.csv', header=None, mode='a')
        else:
            continue
    else:
        continue
